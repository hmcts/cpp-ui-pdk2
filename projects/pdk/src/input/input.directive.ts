...
export class PdkInputComponent {}

@Directive({ selector: '[pdk-input], [pdk-input-width]' })
export class PdkInputDirective {
  @Input('pdk-input')
  set width(width: InputWidth | undefined) {
    this._input = true;
    this._width = width || null;
  }

  @Input('pdk-input-width')
  set pdkInputWidth(width: InputWidth) {
    this._width = width;
  }
