...
@Component({
  ...
  `,
  imports: [PdkTabsContainerComponent]
})
export class PdkTabsNavigationComponent {
  @Input() vertical = false;
}

@Directive({ selector: 'pdk-tabs-nav-item' })
export class PdkTabsNavItemDirective {
...
@Directive({ selector: 'a[pdk-tabs-link]' })
export class PdkTabsLinkDirective {
  ...
  constructor(private tabsNavItem: PdkTabsNavItemDirective) {}
}
